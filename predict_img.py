      ...
      buffer_pre.append(preprocessed)
       ...
       if elapsed % FLAGS.queue == 0:
            ...
            for img, single_out, c2, c3, c4, c5 in zip(buffer_inp, net_out, my_c2, my_c3, my_c4, my_c5):
                rois, num_true_rois = my_postprocess(
                    tfnet.framework, single_out, img)
                ...
                for i in range(num_true_rois):
                    ...
                    mask = imresize(mask, (bot - top, right - left),
                    ...
                    img[top:bot, left:right] = cv2.addWeighted(
                        img[top:bot, left:right], 1.0, mask3, 0.8, 0)
